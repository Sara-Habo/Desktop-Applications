...
"                      border-radius : 45; }")
        ...
        self.piano.setText("")
        self.piano.setPixmap(QtGui.QPixmap("../TASK3/484-4844993_keyboard-cartoon-piano-hd-png-download.png"))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.B_guitar.setGeometry(QtCore.QRect(390, 440, 351, 20))
        ...
        self.D_guitar.setGeometry(QtCore.QRect(390, 390, 351, 20))
        ...
        self.A_guitar.setGeometry(QtCore.QRect(400, 350, 341, 20))
        ...
        self.E_guitar.setGeometry(QtCore.QRect(740, 360, 631, 20))
        ...
        self.G_guitar.setGeometry(QtCore.QRect(740, 400, 631, 20))
        ...
        self.drum.setGeometry(QtCore.QRect(310, 50, 1081, 761))
        self.drum.setText("")
        self.drum.setPixmap(QtGui.QPixmap("drum.jpeg"))
        self.drum.setScaledContents(True)
        self.drum.setObjectName("drum")
        self.drum_center = QtWidgets.QPushButton(self.drums_tab)
        self.drum_center.setGeometry(QtCore.QRect(560, 250, 631, 141))
        ...
        self.drum_buttom.setGeometry(QtCore.QRect(610, 440, 471, 91))
